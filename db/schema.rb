...
ActiveRecord::Schema.define(version: 20151007234245) do
  ...
  add_index "rateables", ["post_id"], name: "index_rateables_on_post_id"
  ...
  add_index "rateables", ["topic_id"], name: "index_rateables_on_topic_id"
